                        ...
                        <div class="table-responsive p-0">
                            <table class="table align-items-center mb-0">
                                ...
                                @foreach ($subData as $subProgram)
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="POST" action="{{ route('kelola.update', $subProgram->id) }}">
                                                            @csrf
                                                            @method('PUT')
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <input type="file" id="imageInput" name="gambar[]" accept="image/*" multiple
                                    ...
                                    {{-- Hapus Program --}}
                                    <div class="modal fade" id="modal-notification-{{ $subProgram->id }}" tabindex="-1" role="dialog" aria-labelledby="modal-notification"
                                        aria-hidden="true">
        ...
        <div class="modal fade" id="exampleModalMessage" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" action="{{ route('kelola.create') }}">
                            @csrf
                            <div class="form-group">

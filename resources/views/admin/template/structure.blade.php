...
<body class="g-sidenav-show  bg-gray-100">
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
        ...
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href={{ route('dashboard') }}>
                <img src={{ asset('AdminUI/assets/img/admin/logo.png') }} class="navbar-brand-img h-100"
                    alt="main_logo">
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('program') ? 'active' : '' }} {{ request()->routeIs('kelola') ? 'active' : '' }}"
                        href={{ route('program') }}>
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">
                            {{ request()->routeIs('kelola') ? 'Program / ' : '' }}{{ $context }}</li>
                    </ol>
    ...
    <!--   Core JS Files   -->
    <script src={{ asset('AdminUI/assets/js/core/popper.min.js') }}></script>
    <script src={{ asset('AdminUI/assets/js/core/bootstrap.min.js') }}></script>
    <script src={{ asset('AdminUI/assets/js/plugins/perfect-scrollbar.min.js') }}></script>
    <script src={{ asset('AdminUI/assets/js/plugins/smooth-scrollbar.min.js') }}></script>
    <script src={{ asset('AdminUI/assets/js/plugins/chartjs.min.js') }}></script>
    ...
    <script>
        document.getElementById('logout-btn').addEventListener('click', function(e) {
            ...
            Swal.fire({
                ...
                text: "Anda akan logout dari akun!",
                icon: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
                confirmButtonText: 'Ya, logout!',
                cancelButtonText: 'Batal' // Menambahkan teks tombol Batal
            }).then((result) => {
    ...
    <script src={{ asset('AdminUI/assets/js/soft-ui-dashboard.min.js?v=1.0.7') }}></script>
</body>
